...
public class ProductoAjustado implements Producto
{
    ...
    public int getPrecio( )
    {
    	...
    	for (int i = 0; i < agregados.size(); i++) {
			sumaExtras += agregados.get(i).getCostoAdicional();
		}
        return sumaExtras + productoBase.getPrecio();
    }
    ...
    public void anadirAgregados(Ingrediente e) {
         agregados.add(e);
    }

    public void anadirEliminados(Ingrediente e) {
         eliminados.add(e);
    }
